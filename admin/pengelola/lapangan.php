      ...
      <section class="wrapper">
        ...
        <div>
          <table class="table table-bordered table-striped table-hover">
            ...
            $data = mysqli_query($koneksi, "SELECT * FROM lapangan WHERE id_pengelola = '$id_pengelola'");
            foreach ($data as $row) {
              ?>
        <tr>
            <td>
            <h4><b><?php echo $row['id_lapangan'];?>
            </td>
            <td>
            <h4><?php echo $row['nama_lapangan'];?>
            </td>
            <td>
              <h4><?php echo $row['harga_lapangan'];?>
            </td>
            <td>
              <h4><?php echo $row['harga_lapangana'];?>
            </td>
            <td>
              <h4><?php echo"<a href='editlapangan.php?id_lapangan=$row[id_lapangan]'> Edit </a>
            </td>
            <td>
