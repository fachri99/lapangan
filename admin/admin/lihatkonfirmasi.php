            ...
            <section class="wrapper">
                ...
                <div>
                    ...
                    ?>
                        ...
                        <div style="padding-bottom:20px">
                            <input class="form-control" name="nama_lapangan" type="text" value="<?php echo $row['id_sewa']; ?>">
                        </div>
                        <label for="inputdefault">
                            Tanggal Konfirmasi</h4>
                        </label>
                        <div style="padding-bottom:20px">
                            <input class="form-control" name="harga_lapangan" type="text" value="<?php echo $row['tgl_konfirmasi']; ?>">
                        </div>
                        <label for="inputdefault">
                            <h4><b>Bukti</h4>
                        </label>
