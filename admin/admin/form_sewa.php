    ...
    <input type="text" name="id_pelanggan" class="form-control" placeholder="id user" required value="<?php echo $id_konfirmasi; ?>" readonly>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="text" name="tgl_main" id="tgl_main" class="form-control datepicker" data-date-format="yyyy-mm-dd" data-date-start-date="+1d" placeholder="Silahkan Pilih Hari">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <select name="jam_mulai" id="jam_mulai"class='form-control' onchange="sum()">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <select name="jam_selesai" id="jam_selesai" class='form-control' onchange="sum();">
                  <option value="09:00:00">09:00</option>
                  <option value="10:00:00">10:00</option>
                  <option value="11:00:00">11:00</option>
                  <option value="12:00:00">12:00</option>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="text" name="lama_sewa"  id="lama_sewa" class="form-control" placeholder="Lama Sewa" readonly>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12">
...
{
          var Hasilharga = document.getElementById('harga').value;
...
function coba() {
var tanggal = document.getElementById('tgl_main').value;
document.getElementById('lama_sewa').value=tan;
