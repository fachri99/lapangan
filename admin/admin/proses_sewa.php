...
$data  = mysqli_fetch_assoc($query);
			...
			$insert="INSERT INTO `sewa`(`id_sewa`,`id_lapangan`,`tgl_pesan`,`jam_mulai`,`jam_selesai`,`lama_sewa`,`total`,`id_pelanggan`,`id_pengelola`) VALUES('$id_Order','$id_lapangan','$tanggal','$gabungA','$gabungB','$lama_sewa','$total','$id_pelanggan','$id_pengelola')";
